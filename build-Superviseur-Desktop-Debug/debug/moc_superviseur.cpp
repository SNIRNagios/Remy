...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Superviseur_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Superviseur_t qt_meta_stringdata_Superviseur = {
    {
QT_MOC_LITERAL(0, 0, 11) // "Superviseur"
...
const QMetaObject Superviseur::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Superviseur.data,
      qt_meta_data_Superviseur,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Superviseur::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Superviseur.stringdata0))
        return static_cast<void*>(const_cast< Superviseur*>(this));
